        ...
        ***********************************-->
        <div class="nav-header">
            <div class="brand-logo">
                <a href="index.html">
                    <b class="logo-abbr"><img src="{{asset('/dashboard-assets')}}/images/logo.png" alt=""> </b>
                    <span class="logo-compact"><img src="{{asset('/dashboard-assets')}}/images/logo-compact.png" alt=""></span>
                    <span class="brand-title">
                        <img src="{{asset('/dashboard-assets')}}/images/logo-text.png" alt="">
                    </span>
                </a>
            </div>
        </div>
                                    ...
                                    <ul>
                                        <li class="notification-unread">
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="{{asset('/dashboard-assets')}}/images/avatar/1.jpg" alt="">
                                        ...
                                        <li class="notification-unread">
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="{{asset('/dashboard-assets')}}/images/avatar/2.jpg" alt="">
                                                <div class="notification-content">
                                        ...
                                        <li>
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="{{asset('/dashboard-assets')}}/images/avatar/3.jpg" alt="">
                                                <div class="notification-content">
                                        ...
                                        <li>
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="{{asset('/dashboard-assets')}}/images/avatar/4.jpg" alt="">
                                                <div class="notification-content">
                ...
                <div class="row">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center">
                                    <img src="{{asset('/dashboard-assets')}}/images/users/8.jpg" class="rounded-circle" alt="">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center">
                                    <img src="{{asset('/dashboard-assets')}}/images/users/5.jpg" class="rounded-circle" alt="">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center">
                                    <img src="{{asset('/dashboard-assets')}}/images/users/7.jpg" class="rounded-circle" alt="">
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center">
                                    <img src="{{asset('/dashboard-assets')}}/images/users/1.jpg" class="rounded-circle" alt="">
                                ...
                                <div class="active-member">
                                    <div class="table-responsive">
                                        <table class="table table-xs mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><img src="{{asset('/dashboard-assets')}}/images/avatar/1.jpg" class=" rounded-circle mr-3" alt="">Sarah Smith</td>
                                                    <td>iPhone X</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    <td><img src="{{asset('/dashboard-assets')}}/images/avatar/2.jpg" class=" rounded-circle mr-3" alt="">Walter R.</td>
                                                    <td>Pixel 2</td>
                                                ...
                                                <tr>
                                                    <td><img src="{{asset('/dashboard-assets')}}/images/avatar/3.jpg" class=" rounded-circle mr-3" alt="">Andrew D.</td>
                                                    <td>OnePlus</td>
                                                ...
                                                <tr>
                                                    <td><img src="{{asset('/dashboard-assets')}}/images/avatar/6.jpg" class=" rounded-circle mr-3" alt=""> Megan S.</td>
                                                    <td>Galaxy</td>
                                                ...
                                                <tr>
                                                    <td><img src="{{asset('/dashboard-assets')}}/images/avatar/4.jpg" class=" rounded-circle mr-3" alt=""> Doris R.</td>
                                                    <td>Moto Z2</td>
                                                ...
                                                <tr>
                                                    <td><img src="{{asset('/dashboard-assets')}}/images/avatar/5.jpg" class=" rounded-circle mr-3" alt="">Elizabeth W.</td>
                                                    <td>Notebook Asus</td>
                            ...
                            <div class="card-body">
                                ...
                                <div id="activity">
                                    <div class="media border-bottom-1 pt-3 pb-3">
                                        <img width="35" src="{{asset('/dashboard-assets')}}/images/avatar/1.jpg" class="mr-3 rounded-circle">
                                    ...
                                    <div class="media border-bottom-1 pt-3 pb-3">
                                        <img width="35" src="{{asset('/dashboard-assets')}}/images/avatar/2.jpg" class="mr-3 rounded-circle">
                                        <div class="media-body">
                                    ...
                                    <div class="media pt-3 pb-3">
                                        <img width="35" src="{{asset('/dashboard-assets')}}/images/avatar/3.jpg" class="mr-3 rounded-circle">
                                        <div class="media-body">
